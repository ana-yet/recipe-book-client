...
const HowToUse = () => {
  const steps = [
    {
      icon: (
        <FaSearch className="w-10 h-10 text-primary dark:text-primary/90" />
      ),
    ...
    {
      icon: (
        <FaBookOpen className="w-10 h-10 text-primary dark:text-primary/90" />
      ),
    ...
    {
      icon: (
        <FaPlusCircle className="w-10 h-10 text-primary dark:text-primary/90" />
      ),
    ...
    {
      icon: <FaHeart className="w-10 h-10 text-primary dark:text-primary/90" />,
    ...
    <div>
      <div className="w-full mx-auto  ">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-3xl font-primary font-extrabold text-secondary dark:text-secondary tracking-tight secondary-font">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {steps.map((step, index) => (
              <div key={index} className="pt-6">
                <div className="flow-root bg-white dark:bg-gray-800 rounded-lg px-6 pb-8 shadow-lg h-full transform hover:-translate-y-2 transition-transform duration-300 ease-in-out">
                  <div className="-mt-6">
                    <div>
                      {/* Icon with a styled background */}
                      <span className="inline-flex items-center justify-center p-3 bg-primary-light dark:bg-primary/20 rounded-md shadow-lg">
                        {step.icon}
                      </span>
                    </div>
                    <h3 className="mt-8 text-lg font-bold text-secondary dark:text-secondary tracking-tight">
                      {step.title}
                    </h3>
